...
class ReportFragment : Fragment(), DonationClickListener {
   ...
   private fun setupMenu() {
    ...
    private fun render(donationsList: ArrayList<DonationModel>) {
        val adapter = DonationAdapter(donationsList, this, reportViewModel, reportViewModel.readOnly.value!!)
    ...
    /*private fun render(donationsList: ArrayList<DonationModel>) {
        fragBinding.recyclerView.adapter = DonationAdapter(donationsList, this, reportViewModel, reportViewModel.readOnly.value!!)
