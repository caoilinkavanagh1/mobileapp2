...
class DonateFragment : Fragment() {
    ...
    fun setButtonListener(layout: FragmentDonateBinding) {
        layout.donateButton.setOnClickListener {
            val amountText = layout.paymentAmount.text.toString()

            // val type = layout.etType.text.toString()
            val subject = layout.subject.text.toString()
            val description = layout.description.text.toString()

            if (amountText.isNotBlank() && subject.isNotBlank() && description.isNotBlank() && amountText.isNotBlank()) {
